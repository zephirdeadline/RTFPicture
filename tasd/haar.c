...
int attentionalCascade(feature *feat, SDL_Surface *surf)
{
	...
	s=s+0.3501482858*(evaluate2(-166542.7656250000,-1.0,scaling(surf,feat[(int)123574.0],24)));
	s=s+0.3588661783*(evaluate2(71.4057617188,1.0,scaling(surf,feat[(int)150231.0],24)));
	s=s+0.3579456556*(evaluate2(-62.5541992188,-1.0,scaling(surf,feat[(int)4698.0],24)));
	s=s+0.3595550561*(evaluate2(-1977.2353515625,1.0,scaling(surf,feat[(int)111303.0],24)));
	s=s+0.3348459774*(evaluate2(-47642.3164062500,-1.0,scaling(surf,feat[(int)158774.0],24)));
	s=s+0.3588882768*(evaluate2(-1656.3579101562,1.0,scaling(surf,feat[(int)97152.0],24)));
	s=s+0.3508609110*(evaluate2(-277444.0156250000,-1.0,scaling(surf,feat[(int)50737.0],24)));
	if(s<0)
	{
		return -1;
	}
	...
	s=s+0.3588882768*(evaluate2(-1656.3579101562,1.0,scaling(surf,feat[(int)97152.0],24)));
	s=s+0.3508609110*(evaluate2(-277444.0156250000,-1.0,scaling(surf,feat[(int)50737.0],24)));
	s=s+0.3341957167*(evaluate2(40720.4843750000,-1.0,scaling(surf,feat[(int)83705.0],24)));
	s=s+0.3464962411*(evaluate2(242.9921875000,1.0,scaling(surf,feat[(int)161848.0],24)));
	s=s+0.3513489445*(evaluate2(-858.0461425781,-1.0,scaling(surf,feat[(int)151239.0],24)));
	s=s+0.3594442848*(evaluate2(-39882.2167968750,-1.0,scaling(surf,feat[(int)160159.0],24)));
	s=s+0.3399895850*(evaluate2(-48040.0058593750,1.0,scaling(surf,feat[(int)158152.0],24)));
	s=s+0.3455316920*(evaluate2(97444.1132812500,1.0,scaling(surf,feat[(int)79385.0],24)));
	s=s+0.3505891181*(evaluate2(189576.2343750000,-1.0,scaling(surf,feat[(int)114119.0],24)));
	s=s+0.2745000000*(evaluate2(420635.2500000000,1.0,scaling(surf,feat[(int)121589.0],24)));
	s=s+0.2879353351*(evaluate2(-75.9858398438,-1.0,scaling(surf,feat[(int)110989.0],24)));
	s=s+0.3155607371*(evaluate2(-29706.9599609375,-1.0,scaling(surf,feat[(int)88174.0],24)));
	if(s<0)
	{
		return -1;
	}
	...
	s=s+0.2879353351*(evaluate2(-75.9858398438,-1.0,scaling(surf,feat[(int)110989.0],24)));
	s=s+0.3155607371*(evaluate2(-29706.9599609375,-1.0,scaling(surf,feat[(int)88174.0],24)));
	s=s+0.3051877784*(evaluate2(196285.6875000000,1.0,scaling(surf,feat[(int)3209.0],24)));
	s=s+0.3239764411*(evaluate2(32171.8203125000,1.0,scaling(surf,feat[(int)144706.0],24)));
	s=s+0.3308744088*(evaluate2(-1566.7180175781,1.0,scaling(surf,feat[(int)103752.0],24)));
	s=s+0.3053239231*(evaluate2(73879.6445312500,1.0,scaling(surf,feat[(int)161363.0],24)));
	s=s+0.3332482440*(evaluate2(58.2495117188,1.0,scaling(surf,feat[(int)106360.0],24)));
	s=s+0.3526397980*(evaluate2(27925.7929687500,1.0,scaling(surf,feat[(int)17792.0],24)));
	s=s+0.3421776278*(evaluate2(-21338.0507812500,-1.0,scaling(surf,feat[(int)53523.0],24)));
	s=s+0.3322747845*(evaluate2(-221605.7656250000,-1.0,scaling(surf,feat[(int)52512.0],24)));
	s=s+0.3254612318*(evaluate2(-2427.0075683594,1.0,scaling(surf,feat[(int)39168.0],24)));
	s=s+0.3521342404*(evaluate2(112721.0156250000,1.0,scaling(surf,feat[(int)44683.0],24)));
	if(s<0)
	{
		return -1;
	}
	...
	s=s+0.3254612318*(evaluate2(-2427.0075683594,1.0,scaling(surf,feat[(int)39168.0],24)));
	s=s+0.3521342404*(evaluate2(112721.0156250000,1.0,scaling(surf,feat[(int)44683.0],24)));
	s=s+0.3366655879*(evaluate2(-1511.2357177734,1.0,scaling(surf,feat[(int)103110.0],24)));
	s=s+0.3600959800*(evaluate2(-110715.3984375000,-1.0,scaling(surf,feat[(int)158584.0],24)));
	s=s+0.3496096411*(evaluate2(1978.1313476562,-1.0,scaling(surf,feat[(int)113999.0],24)));
	s=s+0.3550043468*(evaluate2(147461.2265625000,1.0,scaling(surf,feat[(int)32042.0],24)));
	s=s+0.3570875680*(evaluate2(1620.9526367188,-1.0,scaling(surf,feat[(int)72960.0],24)));
	s=s+0.3649019158*(evaluate2(-70.7579956055,-1.0,scaling(surf,feat[(int)158611.0],24)));
	s=s+0.3674185168*(evaluate2(-96131.5859375000,-1.0,scaling(surf,feat[(int)161068.0],24)));
	s=s+0.3470207014*(evaluate2(-1510.7165527344,1.0,scaling(surf,feat[(int)77689.0],24)));
	s=s+0.3646336596*(evaluate2(69.2275390625,1.0,scaling(surf,feat[(int)21916.0],24)));
	s=s+0.3638766617*(evaluate2(543.9663085938,1.0,scaling(surf,feat[(int)100339.0],24)));
	if(s<0)
	{
		return -1;
	}
	...
	s=s+0.3646336596*(evaluate2(69.2275390625,1.0,scaling(surf,feat[(int)21916.0],24)));
	s=s+0.3638766617*(evaluate2(543.9663085938,1.0,scaling(surf,feat[(int)100339.0],24)));
	s=s+0.3366109366*(evaluate2(-183314.5312500000,-1.0,scaling(surf,feat[(int)32312.0],24)));
	s=s+0.3508536433*(evaluate2(177716.8437500000,-1.0,scaling(surf,feat[(int)148131.0],24)));
	s=s+0.3555402037*(evaluate2(68.5185546875,1.0,scaling(surf,feat[(int)151527.0],24)));
	s=s+0.3610591969*(evaluate2(-62.5561523438,-1.0,scaling(surf,feat[(int)148566.0],24)));
	s=s+0.3643341217*(evaluate2(202642.7421875000,1.0,scaling(surf,feat[(int)142877.0],24)));
	s=s+0.3474895121*(evaluate2(-1729.0874023438,1.0,scaling(surf,feat[(int)99231.0],24)));
	s=s+0.3632767373*(evaluate2(-67.7563476562,-1.0,scaling(surf,feat[(int)144868.0],24)));
	s=s+0.3595432231*(evaluate2(-66.62451171882,-1.0,scaling(surf,feat[(int)155217.0],24)));
	s=s+0.3625399296*(evaluate2(204554.3984375000,1.0,scaling(surf,feat[(int)42132.0],24)));
	s=s+0.3293533312*(evaluate2(-188613.3828125000,1.0,scaling(surf,feat[(int)148454.0],24)));
	if(s<0)
	{
		return -1;
	}
	...
	s=s+0.3625399296*(evaluate2(204554.3984375000,1.0,scaling(surf,feat[(int)42132.0],24)));
	s=s+0.3293533312*(evaluate2(-188613.3828125000,1.0,scaling(surf,feat[(int)148454.0],24)));
	s=s+0.3585537566*(evaluate2(-18815.2812500000,-1.0,scaling(surf,feat[(int)15042.0],24)));
	s=s+0.3512636034*(evaluate2(1804.4433593750,-1.0,scaling(surf,feat[(int)73464.0],24)));
	s=s+0.3558099214*(evaluate2(68687.4453125000,1.0,scaling(surf,feat[(int)161324.0],24)));
	s=s+0.3581418468*(evaluate2(65276.2851562500,-1.0,scaling(surf,feat[(int)20690.0],24)));
	s=s+0.3642338154*(evaluate2(55543.8496093750,1.0,scaling(surf,feat[(int)43169.0],24)));
	s=s+0.3369013389*(evaluate2(94404.3906250000,-1.0,scaling(surf,feat[(int)85156.0],24)));
	s=s+0.3485248116*(evaluate2(-179906.7890625000,-1.0,scaling(surf,feat[(int)59108.0],24)));
	s=s+0.3502657693*(evaluate2(-1685.5614013672,1.0,scaling(surf,feat[(int)105550.0],24)));
	s=s+0.3476726823*(evaluate2(-115061.1250000000,-1.0,scaling(surf,feat[(int)313.0],24)));
	s=s+0.3460622355*(evaluate2(-3621.4604492188,1.0,scaling(surf,feat[(int)74665.0],24)));
	if(s<0)
	{
		return -1;
	}
	...
	s=s+0.3476726823*(evaluate2(-115061.1250000000,-1.0,scaling(surf,feat[(int)313.0],24)));
	s=s+0.3460622355*(evaluate2(-3621.4604492188,1.0,scaling(surf,feat[(int)74665.0],24)));
	s=s+0.3570876092*(evaluate2(-221611.679687500,-1.0,scaling(surf,feat[(int)153296.0],24)));
	s=s+0.3522976378*(evaluate2(-11850.4082031250,1.0,scaling(surf,feat[(int)159882.0],24)));
	s=s+0.3587484915*(evaluate2(-11293.7734375000,-1.0,scaling(surf,feat[(int)162198.0],24)));	
	s=s+0.3619413621*(evaluate2(-0.0024414062,-1.0,scaling(surf,feat[(int)154937.0],24)));
	s=s+0.3623473718*(evaluate2(0.0017089844,1.0,scaling(surf,feat[(int)162236.0],24)));	
	s=s+0.3715587115*(evaluate2(-4084.8347167969,1.0,scaling(surf,feat[(int)97161.0],24)));
	s=s+0.3639901738*(evaluate2(-9840.085937500,-1.0,scaling(surf,feat[(int)144534.0],24)));	
	s=s+0.3611290848*(evaluate2(1719.5277099609,-1.0,scaling(surf,feat[(int)112197.0],24)));	
	s=s+0.3562031057*(evaluate2(58.2509765625,1.0,scaling(surf,feat[(int)155896.0],24)));
	s=s+0.3611201575*(evaluate2(730.046875000,-1.0,scaling(surf,feat[(int)38010.0],24)));	
	if(s<0)
	{
		return -1;
	}
	...
	s=s+0.3562031057*(evaluate2(58.2509765625,1.0,scaling(surf,feat[(int)155896.0],24)));
	s=s+0.3611201575*(evaluate2(730.046875000,-1.0,scaling(surf,feat[(int)38010.0],24)));	
	s=s+0.3675034026*(evaluate2(62749.7734375000,1.0,scaling(surf,feat[(int)50735.0],24)));
	s=s+0.3505956031*(evaluate2(-1514.5759277344,1.0,scaling(surf,feat[(int)83990.0],24)));
	s=s+0.3586792068*(evaluate2(-6482.2768554688,-1.0,scaling(surf,feat[(int)137643.0],24)));
	s=s+0.3454440077*(evaluate2(16106.556640625,-1.0,scaling(surf,feat[(int)114033.0],24)));
	s=s+0.2715000000*(evaluate2(142097.953125000,1.0,scaling(surf,feat[(int)5957.0],24)));
	s=s+0.3211744661*(evaluate2(-72745.222656250,-1.0,scaling(surf,feat[(int)92033.0],24)));	
	s=s+0.3367125021*(evaluate2(1621.2572631836,-1.0,scaling(surf,feat[(int)75819.0],24)));
	s=s+0.322410726*(evaluate2(433693.203125000,1.0,scaling(surf,feat[(int)121582.0],24)));
	s=s+0.3310741504*(evaluate2(16371.4794921875,-1.0,scaling(surf,feat[(int)108666.0],24)));
	s=s+0.3474687262*(evaluate2(10422.589843750,1.0,scaling(surf,feat[(int)112677.0],24)));
	if(s<0)
	{
		return -1;
	}
	...
	s=s+0.3310741504*(evaluate2(16371.4794921875,-1.0,scaling(surf,feat[(int)108666.0],24)));
	s=s+0.3474687262*(evaluate2(10422.589843750,1.0,scaling(surf,feat[(int)112677.0],24)));
	s=s+0.3446514519*(evaluate2(-182463.8515625000,-1.0,scaling(surf,feat[(int)155355.0],24)));
	s=s+0.3380385451*(evaluate2(1950.3776855469,-1.0,scaling(surf,feat[(int)77700.0],24)));	
	s=s+0.3641823034*(evaluate2(132924.31250000,1.0,scaling(surf,feat[(int)72424.0],24)));
	s=s+0.3598318504*(evaluate2(3974.2299804688,-1.0,scaling(surf,feat[(int)90330.0],24)));
	s=s+0.3238117088*(evaluate2(363517.04687500,1.0,scaling(surf,feat[(int)27883.0],24)));
	s=s+0.3575199445*(evaluate2(-2022.587402343,1.0,scaling(surf,feat[(int)103620.0],24)));
	s=s+0.3597653144*(evaluate2(-109129.742187500,-1.0,scaling(surf,feat[(int)57575.0],24)));
	s=s+0.3628742629*(evaluate2(25391.6894531250,-1.0,scaling(surf,feat[(int)19741.0],24)));	
	s=s+0.355205019*(evaluate2(240154.679687500,1.0,scaling(surf,feat[(int)133083.0],24)));
	s=s+0.3685997732*(evaluate2(-70.758789062,-1.0,scaling(surf,feat[(int)156492.0],24)));
	if(s<0)
	{
		return -1;
	}
	...
	s=s+0.355205019*(evaluate2(240154.679687500,1.0,scaling(surf,feat[(int)133083.0],24)));
	s=s+0.3685997732*(evaluate2(-70.758789062,-1.0,scaling(surf,feat[(int)156492.0],24)));
	s=s+0.3673430331*(evaluate2(-69.484375000,-1.0,scaling(surf,feat[(int)153030.0],24)));
	s=s+0.3640224773*(evaluate2(57.2971191406,1.0,scaling(surf,feat[(int)159096.0],24)));
	s=s+0.3699412625*(evaluate2(-57.4375000000,-1.0,scaling(surf,feat[(int)155238.0],24)));
	s=s+0.3734535817*(evaluate2(70.9438476562,1.0,scaling(surf,feat[(int)108656.0],24)));	
	s=s+0.3699007883*(evaluate2(2156.5136718750,-1.0,scaling(surf,feat[(int)106228.0],24)));
	s=s+0.3668281381*(evaluate2(62.680664062,1.0,scaling(surf,feat[(int)2976.0],24)));
	s=s+0.3695665421*(evaluate2(-64.6997070312,1.0,scaling(surf,feat[(int)154832.0],24)));
	s=s+0.3720073540*(evaluate2(-274751.32812500,-1.0,scaling(surf,feat[(int)47720.0],24)));
	s=s+0.353154903*(evaluate2(-1501.5483398438,1.0,scaling(surf,feat[(int)104940.0],24)));
	s=s+0.3630895727*(evaluate2(-34315.337890625,-1.0,scaling(surf,feat[(int)140439.0],24)));
	if(s<0)
	{
		return -1;
	}
